...
6.  One Six-Sided Die
7.  One Troll Marker (Two Troll Markers for a 3 player game)
8.  One Dragon Marker
...
2.  If a faction is not being played, then a trol maker is placed
    where there starting units would have gone.
3.  One player is picked at random to be the Stating Player.
4.  The Dragon Marker is placed. Roll the die three times and add the 
...
-   Elven Blessing: After the Elves have lost 3 units in combat, they are
    ...
    gives them two bonus battle point and makes it so they can not be 
