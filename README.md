...
which seem as fundamentally important to the game Dune.
...
4.  Elven units may go into hiding in a territory in order to
    ...
    into a empty territory or they may declare that they are coming out
...
3.  If the event card is the same color as the games current Starting 
    Player, then the Red Dragon has attacked the previous event 
    territory. All units and gold in that territory are lost.
